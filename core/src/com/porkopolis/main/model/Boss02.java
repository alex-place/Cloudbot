...
public class Boss02 extends Entity {
	private float health = 640;
	private float maxHealth = 640;

	private Vector2 hatTip = new Vector2(2.3f, 3f);
	...
	@Override
	public Boss02 init(float x, float y, float width, float height, float rotation, float attackSpeed,
